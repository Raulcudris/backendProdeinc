package com.system.modules.documentosobra.services;
...
public class TraceabilityService {
    ...
    private static final String COMPONENT = "DocumentosObraService";

    private static final String SERVICE = "MSVC_DOCUMENTOS_OBRA";
