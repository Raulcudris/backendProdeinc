 ...
 */
@Component
public class EntyOrsordmaordenservicioEntityToDtoTranslate
        implements Translator<EntyOrsordmaordenservicio, EntyOrsordmaordenservicioDto> {

    @Override
    public EntyOrsordmaordenservicioDto translate(
            final EntyOrsordmaordenservicio input
    ) throws EBusinessException {
        return GsonUtil.getGson()
                .fromJson(
                        GsonUtil.getGson().toJson(input),
                        EntyOrsordmaordenservicioDto.class
                );
    }
}