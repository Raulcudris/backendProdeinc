...
public class NovedadController {
    ...
    public ResponseEntity<String> health() {
        return ResponseEntity.ok("Novedades service OK");
    }
    ...
    public ResponseEntity<EntyOrsconfnovedadhistoriDto> create(
            @RequestBody EntyOrsconfnovedadhistoriResponse request
    ) throws EBusinessException, MicroEventException {

        EntyOrsconfnovedadhistoriDto dto = ResponsePayloadUtil.getFirstData(
                request.getRspData(),
                "Debe enviar una novedad en rspData."
        );
    ...
    public ResponseEntity<List<EntyOrsconfnovedadhistoriDto>> createList(
            @RequestBody EntyOrsconfnovedadhistoriResponse request
    ) throws EBusinessException, MicroEventException {

        List<EntyOrsconfnovedadhistoriDto> dtoList = ResponsePayloadUtil.getData(
                request.getRspData(),
                "Debe enviar novedades en rspData."
        );
