...
@RequestMapping(
        value = "/api/documentos-obra/categorias",
...
public class EntyCategoriaDocumentoWebApi {
    ...
    public ResponseEntity<EntyDoccatmacategoriaResponse> getAll(
    ...
    public ResponseEntity<EntyDoccatmacategoriaDto> create(
            @RequestBody EntyDoccatmacategoriaDto dto
    ) throws EBusinessException, MicroEventException {
        return new ResponseEntity<>(
    ...
    public ResponseEntity<EntyDoccatmacategoriaDto> update(
