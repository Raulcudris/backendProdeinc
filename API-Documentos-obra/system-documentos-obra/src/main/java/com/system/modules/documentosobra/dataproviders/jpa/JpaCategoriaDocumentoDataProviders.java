...
import com.system.modules.documentosobra.dataproviders.IjpaCategoriaDocumentoDataProviders;
...
@DataProvider
public class JpaCategoriaDocumentoDataProviders implements IjpaCategoriaDocumentoDataProviders {

    @Autowired
    private EntyDoccatmacategoriaRepository repository;

    @Autowired
    @Qualifier("entyDoccatmacategoriaEntityToDtoTranslate")
    private Translator<EntyDoccatmacategoria, EntyDoccatmacategoriaDto> entityToDtoTranslate;

    @Autowired
    @Qualifier("entyDoccatmacategoriaDtoToEntityTranslate")
    private Translator<EntyDoccatmacategoriaDto, EntyDoccatmacategoria> dtoToEntityTranslate;

    private static final Logger logger = LogManager.getLogger(JpaCategoriaDocumentoDataProviders.class);

    @Override
    public EntyDoccatmacategoriaResponse getAll() throws EBusinessException {
    ...
    public EntyDoccatmacategoriaResponse getAll(
        ...
        try {
            ...
            Page<EntyDoccatmacategoria> responsePage;

            if (safeFilter.isEmpty() && !"STATUS".equals(safeParameter) && !"ESTADO".equals(safeParameter)) {
            ...
            List<EntyDoccatmacategoriaDto> content = responsePage.getContent()
                    .stream()
                    .map(this::mapToDto)
                    .collect(Collectors.toList());

            EntyDoccatmacategoriaResponse response = new EntyDoccatmacategoriaResponse();
    ...
    @Override
    public EntyDoccatmacategoriaDto get(Integer id) throws EBusinessException {
        try {
            EntyDoccatmacategoria entity = repository.findById(id).orElse(null);

            if (entity == null) {
                return new EntyDoccatmacategoriaDto();
            }
    ...
    @Override
    public EntyDoccatmacategoriaDto save(
    ...
    @Override
    public List<EntyDoccatmacategoriaDto> save(
            List<EntyDoccatmacategoriaDto> dtos
    ) throws EBusinessException {
        try {
            List<EntyDoccatmacategoria> entities = new ArrayList<>();

            for (EntyDoccatmacategoriaDto dto : dtos) {
                entities.add(dtoToEntityTranslate.translate(dto));
            }

            List<EntyDoccatmacategoriaDto> result = new ArrayList<>();

            for (EntyDoccatmacategoria entity : repository.saveAll(entities)) {
    ...
    @Override
    public EntyDoccatmacategoriaDto update(
            Integer id,
            EntyDoccatmacategoriaDto dto
    ) throws EBusinessException {
        try {
            EntyDoccatmacategoria old = repository.findById(id).orElse(null);
            ...
            old.setDocDescripcionCado(dto.getDocDescripcionCado());
            old.setDocEstadoregCado(dto.getDocEstadoregCado());
    ...
    private EntyDoccatmacategoriaDto mapToDto(
            EntyDoccatmacategoria entity
    ) {
        EntyDoccatmacategoriaDto dto = new EntyDoccatmacategoriaDto();
        ...
        try {
            ...
            logger.error(
                    "Error mapeando categoría documental a DTO. ID: {}",
                    entity != null ? entity.getDocPrimarykeyCado() : null,
                    e
            );
